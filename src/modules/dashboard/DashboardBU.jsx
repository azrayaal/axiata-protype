...
function MiniCalendar() {
  ...
  const events = [
    { day: 19, title: 'Reporting Kontrak — KTR-2025-041', sub: 'PKS Distribusi · Prioritas Tinggi', time: '09:30 AM' },
    { day: 19, title: 'Monitoring Kontrak — KTR-2025-033', sub: 'Konsultasi Hukum · Finalisasi', time: '11:30 AM' },
    { day: 20, title: 'Print Hardcopy — KTR-2025-039', sub: 'MOU Distribusi · 1 hr.', time: '' },
  ]
          ...
          {week.map((day, di) => (
            <div
              ...
              className={`text-center text-xs py-1.5 rounded-full cursor-pointer transition-colors ${
                day === today
                  ? 'bg-[#1a3a6b] text-white font-bold'
                  : day ? 'text-gray-600 hover:bg-blue-50' : ''
              }`}
            >
              {day || ''}
            </div>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-5">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
          ...
          <div className="flex items-end gap-2 mb-3">
            ...
            <span className="text-xs text-gray-400 mb-1">TOTAL KONTRAK DI SUBMIT HINGGA SAAT INI</span>
          </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <MetricCard label="KONTRAK MENDESAK" value="5" change="-5,6%" positive={false} icon={AlertTriangle} color="bg-orange-500" />
      ...
      <div className="rounded-xl overflow-hidden shadow-sm bg-gradient-to-r from-[#0e2347] via-[#0e3d6b] to-[#096b5e] p-6">
        <div className="grid grid-cols-4 gap-6">
          ...
          {[
            {
              label: 'Top Kontrak', badge: 'Top Kontrak', count: '12', unit: 'Kontrak',
              ...
              company: 'PT Maju Bersama', labelColor: 'text-blue-300',
            },
            {
              label: 'Top vendor', badge: 'Top vendor', count: '9', unit: 'Kontrak', extra: '1 Aktif',
              ...
              company: 'CV Teknologi', labelColor: 'text-blue-300',
            },
            {
              label: 'Kontrak Berisiko', badge: 'Kontrak Berisiko', count: '3', unit: 'Kontrak',
              ...
              company: 'UD Sumber', labelColor: 'text-red-300',
            },
          ].map((item, i) => (
            <div key={i} className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
              <span className={`text-xs font-semibold ${item.labelColor}`}>{item.badge}</span>
              ...
              <p className={`text-sm font-bold ${item.labelColor}`}>{item.company}</p>
            </div>
          ))}
        </div>
      </div>
